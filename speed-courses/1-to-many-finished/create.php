...
if (isset($_POST['submit'])) {
    ...
    if (empty($errors)) {
        ...
        $query = "INSERT INTO albums (name, artist_id, genre, year, tracks, image)
                  VALUES ('$name', '$artistId', '$genre', $year, $tracks, '$image')";
    ...
    <section class="section grid is-col-min-10">
        <div class="column is-10">
            ...
            <form class="column is-6" action="" method="post">
                ...
                <div class="field is-horizontal">
                    <div class="field-label is-normal">
                        <label class="label" for="tracks">Image file name</label>
                    </div>
                    <div class="field-body">
                        <div class="field">
                            <div class="control">
                                <input class="input <?= isset($errors['image']) ? 'is-danger' : '' ?>" id="image" type="text" name="image"
                                       value="<?= $image ?? '' ?>"/>
                            </div>
                            <p class="help is-danger">
                                <?= $errors['image'] ?? '' ?>
